...
description: 'Get started with Tokenizador in minutes - analyze AI tokens in real-time for 67+ models'
---
...
<Steps>
  ...
  <Step title="Select an AI Model">
    Choose from 67+ supported AI models using the dropdown selector. Models are organized by provider:
...
- **Configuration** (`models-config.js`): All 67+ models with pricing and specs
...
<CardGroup cols={2}>
  ...
  <Card title="Model Reference" icon="book" href="/guides/supported-models">
    Explore detailed information about all 67+ supported models
  </Card>
